...
| Find the pid that owns the port and kill that pid | Ever kill by matching the word partyline in every process's command line — it matches the room you are standing in |
