...
ASK_FIRST = (
    ...
    "shipped, services restarted (dogfooding). Refresh the checkout before planning any "
    "work from it: ask right away (a person pulls; never pull, reset, stash or discard in "
    "a person's checkout). Never plan dogfooding from a stale base, nor cut a child line "
