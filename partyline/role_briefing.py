...
SPLIT = (
    ...
    "SHA on `line/<name>` — never a side branch or a detached tip; if a worker strays, have it "
...
WORKER = (
    ...
    "The captain owns the push. Work on the line's own branch `line/<name>` — one line, one "
