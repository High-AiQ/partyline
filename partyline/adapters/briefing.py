...
BRIEFING = (
    ...
    "| Write @name only when you want that process to act now; name it without the @ "
    "when you are merely talking about it | Put @ on every name you mention — each @ "
    "rings that process and spends its turn |\n"
    "\n"
    "## Working etiquette\n"
